/*
  ...
  - Added the required column `id_grupo` to the `Reserva` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `reserva` ADD COLUMN `id_grupo` VARCHAR(191) NOT NULL,
